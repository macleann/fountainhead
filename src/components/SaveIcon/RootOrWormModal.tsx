...
const RootOrWormModal: React.FC<RootOrWormModalProps> = ({ isOpen, onClose, onChoice }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-black border border-white w-80">
        <div className="bg-white px-2 py-1 flex justify-between items-center">
          <span className="text-black text-sm">Root or Worm</span>
          <button onClick={onClose} className="text-black">
            ✕
          </button>
        </div>
        <div className="p-4">
          <p className="text-white mb-4">Are you the root or the worm?</p>
